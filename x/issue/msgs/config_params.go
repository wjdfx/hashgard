...
var _ params.ParamSet = &IssueConfigParams{}
...
func ParamKeyTable() params.KeyTable {
	return params.NewKeyTable().RegisterParamSet(&IssueConfigParams{})
}

// ParamSetPairs implements the ParamSet interface and returns all the key/value pairs
// pairs of auth module's parameters.
// nolint
func (p *IssueConfigParams) ParamSetPairs() params.ParamSetPairs {
...
func DefaultParams(denom string) IssueConfigParams {
...
func (dp IssueConfigParams) String() string {
	return fmt.Sprintf(`IssueConfigParams:
  IssueFee:			%s
  MintFee:			%s
  FreezeFee:			%s
  UnFreezeFee:			%s
