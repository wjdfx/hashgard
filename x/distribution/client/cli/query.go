...
import (
	...
	"github.com/hashgard/hashgard/x/distribution/client/common"
...
$ hashgardcli distribution commission gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ hashgardcli distribution slashes gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 0 100
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ hashgardcli distribution rewards gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
$ hashgardcli distribution rewards gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
