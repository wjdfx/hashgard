...
func (mc ModuleClient) GetCmd() *cobra.Command {
	boxCmd := &cobra.Command{
		...
		Long: "Hashgard supports the token lock-up function, financial institutions and users can lock up tokens for a limited period of time in financial activities. It has following features:" +
