...
func TestHashgardCLIKeysAddRecover(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIMinimumFees(t *testing.T) {
	...
	// start hashgard server with minimum fees
...
func TestHashgardCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start hashgard server with minimum fees
	minGasPrice, _ := sdk.NewDecFromStr("0.000006")
	proc := f.HGStart(fmt.Sprintf("--minimum-gas-prices=%s", sdk.NewDecCoinFromDec(feeDenom, minGasPrice)))
	defer proc.Stop(false)
...
func TesthashgardCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIConfirmTx(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	unbondAmt := sdk.NewCoin(app.StakeDenom, sdk.TokensFromTendermintPower(1))
...
func TestHashgardCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIQueryTxPagination(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgardCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestHashgarddCollectGentxs(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
...
func TestHashgarddAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
...
func TestSlashingGetParams(t *testing.T) {
	...
	sinfo := f.QuerySigningInfo(f.HGTendermint("show-validator"))
