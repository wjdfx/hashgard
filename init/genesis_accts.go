	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, args []string) error {
			...
			if !common.FileExists(genFile) {
				return fmt.Errorf("%s does not exist, run `hashgard init` first", genFile)
			}
...
func addGenesisAccount(cdc *codec.Codec, appState app.GenesisState, addr sdk.AccAddress, coins, vestingAmt sdk.Coins, vestingStart, vestingEnd int64) (app.GenesisState, error) {
