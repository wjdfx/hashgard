...
func TestPoolParamsQuery(t *testing.T) {
	...
	initialPool.BondedTokens = initialPool.BondedTokens.Add(tokens)           // Delegate tx on HashgardAppGenState
	initialPool.NotBondedTokens = initialPool.NotBondedTokens.Add(freeTokens) // freeTokensPerAcc = 50 on HashgardAppGenState
...
func TestProposalsQuery(t *testing.T) {
	...
	halfMinDeposit := depositParam.MinDeposit.AmountOf(app.StakeDenom).QuoRaw(2)
