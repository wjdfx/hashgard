...
func makeGenesisState(t *testing.T, genTxs []auth.StdTx) GenesisState {
	...
	stakeData := appState.StakingData
...
func TestHashgardAppGenTx(t *testing.T) {
	cdc := MakeCodec()
	_ = cdc
...
func TestHashgardAppGenState(t *testing.T) {
	cdc := MakeCodec()
	_ = cdc
...
func TestGenesisStateSanitize(t *testing.T) {
	...
	require.Nil(t, authAcc1.SetCoins(sdk.NewCoins(
	...
	require.Nil(t, authAcc2.SetCoins(sdk.NewCoins(
		sdk.NewInt64Coin("acoin", 150),
		sdk.NewInt64Coin("bcoin", 150),
	)))
